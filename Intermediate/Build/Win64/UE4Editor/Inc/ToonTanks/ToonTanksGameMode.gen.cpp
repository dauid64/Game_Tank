...
// End Cross Module References
	...
	void AToonTanksGameMode::GameOver(bool WonGame)
	{
		ToonTanksGameMode_eventGameOver_Parms Parms;
		Parms.WonGame=WonGame ? true : false;
	...
	{
		static void NewProp_WonGame_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_WonGame;
	...
	void Z_Construct_UFunction_AToonTanksGameMode_GameOver_Statics::NewProp_WonGame_SetBit(void* Obj)
	{
		((ToonTanksGameMode_eventGameOver_Parms*)Obj)->WonGame = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AToonTanksGameMode_GameOver_Statics::NewProp_WonGame = { "WonGame", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ToonTanksGameMode_eventGameOver_Parms), &Z_Construct_UFunction_AToonTanksGameMode_GameOver_Statics::NewProp_WonGame_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AToonTanksGameMode_GameOver_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AToonTanksGameMode_GameOver_Statics::NewProp_WonGame,
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AToonTanksGameMode_StartGame_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//para usar em blueprint\n" },
		{ "ModuleRelativePath", "ToonTanksGameMode.h" },
		{ "ToolTip", "para usar em blueprint" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AToonTanksGameMode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AToonTanksGameMode_GameOver, "GameOver" }, // 819588761
		{ &Z_Construct_UFunction_AToonTanksGameMode_StartGame, "StartGame" }, // 1528987824
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AToonTanksGameMode, 273202372);
