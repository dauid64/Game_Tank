...
#define ToonTanks_Source_ToonTanks_BasePawn_h_12_PRIVATE_PROPERTY_OFFSET \
	...
	FORCEINLINE static uint32 __PPO__ProjectilesSpawnPoint() { return STRUCT_OFFSET(ABasePawn, ProjectilesSpawnPoint); } \
	FORCEINLINE static uint32 __PPO__ProjectileMesh() { return STRUCT_OFFSET(ABasePawn, ProjectileMesh); } \
	FORCEINLINE static uint32 __PPO__DeathParticles() { return STRUCT_OFFSET(ABasePawn, DeathParticles); } \
	FORCEINLINE static uint32 __PPO__HitSound() { return STRUCT_OFFSET(ABasePawn, HitSound); } \
